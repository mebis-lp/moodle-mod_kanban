...
$string['history_card_assigned'] = '{$a->username} assigned card {$a->title} to user {$a->affectedusername}';
$string['history_card_deleted'] = '{$a->username} deleted card {$a->title} from column {$a->columnname}';
$string['history_card_moved'] = '{$a->username} added card {$a->title} to user {$a->affectedusername}';
$string['history_card_updated'] = '{$a->username} added card {$a->title}';
$string['history_card_unassigned'] = '{$a->username} unassigned card {$a->title} from user {$a->affectedusername}';
...
$string['reset_kanban'] = 'Reset course boards';
