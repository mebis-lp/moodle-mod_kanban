...
$string['message_assigned_subject'] = 'Card assigned';
$string['message_changed_fullmessage'] = 'Card "{$a->title}" was changed by {$a->username}';
$string['message_changed_smallmessage'] = 'Card changed';
$string['message_changed_subject'] = 'Card changed';
...
{$a->username}
{$a->content}';
$string['message_discussion_smallmessage'] = 'Card discussed';
$string['message_discussion_subject'] = 'Card discussed';
$string['message_due_fullmessage'] = 'Card "{$a->title}" in board "{$a->boardname}" is due at {$a->username}';
$string['message_due_smallmessage'] = 'Card due';
$string['message_due_subject'] = 'Card due';
...
$string['message_unassigned_subject'] = 'Card assigned';
$string['messageprovider:assigned'] = 'Card assigned / unassigned';
$string['messageprovider:changed'] = 'Card changed';
